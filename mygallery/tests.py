...
class LocationTestClass(TestCase):
    # Set up method
    def setUp(self):
        self.location = Location(id = 1,name = 'kenya')
    ...
    def test_update_method(self):
        self.location.save_location()
        self.location = Location.objects.filter(name = 'kenya').update(name = 'Uganda')
        self.updated_location = Location.objects.get(name = 'Uganda')
        self.assertEqual(self.updated_location.name,"Uganda")
